  ...
  return (
    <div className="md:w-6/12 md:mx-auto md:my-4 bg-gray-50 shadow-lg p-4">
      <div className="flex justify-between">
        <span className="text-3xl font-bold text-gray-800 mb-2 mr-2">
          {name}{" "}
        </span>
        <span className="text-1xl font-bold text-gray-800 mt-3 mb-2 mr-2">
          ₹ {costForTwo / 100}, {city}, {cuisines}, {locality}
        </span>
